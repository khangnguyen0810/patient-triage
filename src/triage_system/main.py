...
def run_interactive_demo():
    ...
    session_state = PatientSessionState(
        patient_id="PT-7721",
        raw_symptoms=["I have sharp chest pain spreading to my arm, and I am feeling very dizzy."]
    ) # type: ignore
    ...
    print(f"State successfully mutated. 'selected_department' locked to: {session_state.selected_department}")
