...
class PatientSessionState(BaseModel):
    ...
    """
    patient_id: str = Field(..., description="Unique identification string for the patient.")
    raw_symptoms: List[str] = Field(default_factory=list, description="Symptoms explicitly provided by the patient.")
